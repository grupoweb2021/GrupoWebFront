<template>
  <div>
            ...
            <v-menu open-on-hover top offset-y>
              ...
              <v-list>
                <v-list-item v-for="(pet, index) in pets" :key="index">
                  <v-list-item-title
                    type="button"
                    @click="filFormPubication(pet)"
                    >{{ pet.name }}</v-list-item-title
                  >
                </v-list-item>
              </v-list>
            </v-menu>
    ...
    >
      <v-text-field solo filled disabled placeholder="Agregar Publicación">
      </v-text-field>
    </v-card>
...
export default {
  ...
  methods: {
    ...
    getPets() {
      PetsService.getPets(UserService.currentUser).then((response) => {
    ...
    DeletePublication(id) {
      PublicationsService.DeletePublication(id).then(this.retrievePublications);
    },
    setDialog(flag) {
      this.dialog = flag;
    },
    ...
    filterPet() {
      ...
      {
      PetsService.filterPet(UserService.currentUser,this.variables[i])
      .then((response) => {
